...
class CarMake(models.Model):
    name = models.CharField(max_length=40, null=False, default='BMW')
    description = models.CharField(max_length=255, default='BMW good', null=False)
...
class CarModel(models.Model):
    ...
    WAGON = 'wagon'
    OTHERS = 'others'
    CAR_CHOICES = [(BMW, "BMW"), (SEDAN, "Sedan"), (SUV, 'SUV'), (WAGON, 'Wagon'), (OTHERS, 'Others')]
